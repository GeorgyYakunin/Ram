...
public class BatteryWidgetsProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try
        {
            if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
                ...
                if (prevLevel != level )
                {
                    Log.d(BatteryWidgetsProvider.TAG,"---------- onReceive() " + action + " prevLevel " + prevLevel);
                    prevLevel = level;
        ...
        }catch(Exception e){Log.e(BatteryWidgetsProvider.TAG, "", e);}
    ...
    public static class UpdateService extends Service {
        ...
        public void updateWidget(Context context, Intent batteryIntent){
            ...
            RemoteViews updateViews = new RemoteViews(context.getPackageName(), R.layout.widgetbattery);
            ...
            updateViews.setOnClickPendingIntent(R.id.layout ,
                    PendingIntent.getActivity(context, 0,
                            new Intent(context, ActivitySaveBattery.class),Intent.FLAG_ACTIVITY_CLEAR_TASK));

            ComponentName myComponentName = new ComponentName(context, BatteryWidgetsProvider.class);
